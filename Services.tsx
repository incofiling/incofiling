...
export default function ServicesGrid() {
  const services = [
    {
      icon: <Landmark className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
    ...
    {
      icon: <HandCoins className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
    ...
    {
      icon: <FileSignature className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
      title: "Operating Agreement",
      description: "Get an operating agreement to define your LLC's internal structure and each member's roles.",
    },
    {
      icon: <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
    ...
    {
      icon: <FileEdit className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
    ...
    {
      icon: <FileX className="w-5 h-5 sm:w-6 sm:h-6 text-[#240645]" />,
      title: "Dissolution",
      description:
    ...
    <div id="services" className="w-full bg-white py-8 sm:py-10 md:py-12 lg:py-16 px-3 sm:px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <p className="text-[#240645] font-medium text-sm sm:text-base mb-1 sm:mb-2">More Services</p>
